...
// 测试获取单条俱乐部信息
func testClubGetOne(c *rpc.Client) error {
...
// 测试创建新的俱乐部
func testClubCreate(c *rpc.Client) error {
	var (
...
func testClubUpdate(c *rpc.Client) error {
...
func testClubDelete(c *rpc.Client) error {
...
func testClubGetMany(c *rpc.Client) error {
	return nil
}
...
func main() {
	...
	c := rpc.NewClient("tcp", ":" + port, 10 * time.Minute)
	// defer c.Close()
