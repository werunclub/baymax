module github.com/werunclub/baymax/v2

go 1.16

require (
	github.com/bmizerany/assert v0.0.0-20160611221934-b7ed37b82869 // indirect
	github.com/club-codoon/go-nsq v1.0.7-0.20201024070210-9b417f42636f
...
replace github.com/vrischmann/go-metrics-influxdb => github.com/werunclub/go-metrics-influxdb v1.0.1
